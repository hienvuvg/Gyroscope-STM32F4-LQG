...
void loop() {
  ...
  /* Print Data */
  Serial.print("\t theta1: ");Serial.print(kalAngleX,2);
  Serial.print("\t alpha1: ");Serial.print(kalAngleY,2);

   readMPU(IMUAddress2);
  Serial.print("\t theta2: ");Serial.print(kalAngleX,2);
  Serial.print("\t alpha2: ");Serial.print(kalAngleY,2);
  
  timer_2 = micros();
  deltaTime =  timer_2 - timer_1;
  Serial.print("\t time: ");Serial.print(deltaTime,2);
  
  Serial.print("\r\n");
}

void readMPU (uint8_t IMUAddressX){
