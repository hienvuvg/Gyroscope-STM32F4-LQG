...
void setup() {
  ...
  attachInterrupt (interrupt0, encoderFunc, FALLING);
...
void loop() {
  readMPU1();
    alphaD = 3*pulse/5; // y = x*360/600
  thetaD = kalAngleX;
  Serial.print ("\t alpha: ");Serial.print (alphaD);
    Serial.print ("\t theta: ");Serial.print (thetaD);
  Serial.print ("\n");
}

void encoderFunc( void){
