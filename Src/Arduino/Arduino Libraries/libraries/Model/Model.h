...
struct GyroModel : public Model<5,1,2>
{
  GyroModel(float Mb,float Mg,float Hg,float Hb,float Ibx,float Ip,float Ir,float w,float g,float L,float R,float Bm,float Km,float Ke,float Kt)
  {
